...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DSC866D1.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-1Mv2IHdo.mjs"),
		import("./start-CSiD7Sib.mjs"),
...
//#endregion
export { server_default as default, createMiddleware as n, renderErrorPage as r, createStart as t };
