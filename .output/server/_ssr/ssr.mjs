...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CS1lMMPx.mjs");
...
var manifest = {
	"41c1dcab2396354bf71df127871aed84cfb5bc64ee848a2b93099707bb342d3c": {
		functionName: "submitLead_createServerFn_handler",
		importer: () => import("./contact-Bd9GesW6.mjs")
	},
	"574f011d578dc332be23069bb58c06de76b107ae651a0d64fd7ea6252848b8fa": {
		functionName: "recordPageView_createServerFn_handler",
		importer: () => import("./analytics-C8ffE5KE.mjs")
	},
	"7a3bc30fb68ffe0008bc2f1e589d8ecce862d54e330c5fd738480465ec943b6a": {
		functionName: "subscribeNewsletter_createServerFn_handler",
		importer: () => import("./NewsletterOptin-BZCjHPm7.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-GfM6iWf0.mjs"),
		import("./start-BzD1B2O2.mjs"),
...
//#endregion
export { createStart as a, ssr_exports as c, createServerFn as i, createCsrfMiddleware as n, getServerFnById as o, createMiddleware as r, renderErrorPage as s, TSS_SERVER_FUNCTION as t };
